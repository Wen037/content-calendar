...
public class ContentController {
    ...
    */
    ...
    Content updatedContent = new Content(
        ...
        content.getTitle(),            // new title
        content.getDescription(),             // new description
        content.getStatus(),           // new status
        content.getContentType(),      // new content type
        content.getUrl()               // new URL
    );
